...
values_murcia = np.asarray(estaciones_en_murcia["P20"])
...
#plt.show()
#plt.figure(figsize=(8, 8))
plt.contourf(grid_lon, grid_lat, masked_grid_z, cmap=daily_precipitation_cmap, norm=precipitation_norm, extent=hillshade_extent, alpha=0.7)
plt.scatter(lons_murcia, lats_murcia, c=values_murcia, cmap=daily_precipitation_cmap, norm=precipitation_norm, edgecolor='k', s=100, alpha=0.7, label='Datos Observados')
